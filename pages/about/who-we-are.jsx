    ...
    <Base
      ...
      />
        ...
        <div className={`containerBox ${styles.anchor} px-4 px-lg-5 px-xl-0 lh-34`}>
            ...
            <section id="OurPurpose" className="row containerBox text-justify align-items-center">
            ...
            <section
                ...
                <p className="m-0 fs-16 lh-34">
                    ...
                    free to immerse themselves in different cultures and ways of life, free from
            ...
            <section
                ...
                <p className="m-0 fs-16 lh-34">
                    ...
                    well as ethical and sustainable tourism.
                </p>
                </div>
            </section>
            <section
                ...
                <p className="m-0 fs-16 lh-34">
                    ...
                    as the cultural and historical magnificence of its countries, positively
                    contributing to local communities and travellers to the continent.
                </p>
                </div>
              ...
              <div className="row mb-5 pt-5">
                <div className="col-12 mb-5 col-lg-6 order-1 order-md-1 col-md-12 m-0 fs-17 lh-34 text-fluid align-self-center">
                  <p>
                    ...
                    world of tourism. René, a professional guide and the actual CMO of the
                    ...
                    planet. The name of the company was inspired by their mothers’
                    surname, Valencia, originating from Spain.
                  </p>
                  <p>
            ...
            <section id="WhyVaExpeditions" className="row align-items-center m-0 pb-5">
                ...
                <div className="row mb-5">
                    ...
                    <div className="col-12 col-md-6 mb-3 mb-md-5 order-1 order-md-2 align-self-center">
