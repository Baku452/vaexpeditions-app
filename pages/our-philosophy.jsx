    ...
    <Base destinations={destinations} packagetypes={packagetypes}>
      ...
      <section id="more">
        ...
        <div className="container text-justify">
          <div className="row mb-5 contactus-text">
            <div className="col-lg-6 col-md-12 mt-5 pl-5">

              <h3>Our Philosophy</h3>
              <br />

              <p>At Valencia Travel we have a philosophy that guides everything we do. We believe:
            </p>
              <p>
          ...
          <div className="contactus-text">
            ...
            <ul>
              ...
              <li>
                Disproving false beliefs will help us to live without fear and ascertain the true nature of all destinations.
              </li>
              <li>
                We always have an open mind and an inclusive perspective when we look at different cultures and the huge diversity they reveal,
                and we believe that you have to travel to open your mind and learn to trust new people.
              </li>
              <li>
                Being responsible and aware of the environment will help us grow as one global community.
              </li>
              <li>
                We always promote the highest environmental sustainability practices, as a basis for achieving global development and improving people's quality of life.
              </li>
            </ul>
