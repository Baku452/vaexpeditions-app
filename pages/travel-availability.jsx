              ...
              <div className="row mb-5">
                <div className="col-12 col-lg-6 mb-3">
                  ...
                  <p className="m-0 fs-20 lh-34 ">
                    ...
                    such as Mexico, Spain, USA and most European destinations, now open,
                    which has made us all believe here at Va Expeditions that things are
                    starting to get back to some kind of normal and we are super excited!
                    Here at Va Expeditions, we are now operating ALL of our tours and
                    excursions for the first time since the pandemic began with the
                    exception of Argentina, Bolivia and Chile, who´s international borders
                    remain closed.
                  </p>
                  <p />
                </div>
