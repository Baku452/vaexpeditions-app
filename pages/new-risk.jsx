                ...
                <div className="row justify-content-md-center">
                  <div className="col-10 mb-3">
                    ...
                    <p className="m-0 fs-18 lh-34">
                      With uncertainty around travel in a post-Coronavirus world, even the
                      hardy travellers who are participants on Valencia Travel are feeling
                      understandably anxious and seeking assurance. It is clear that for
                      the time being, the complicated web of restrictions and flight
                      cancelations make travel impossible right now. So we have worked
                      with all our guests on a case-by-case basis to find the best
                      solution for them, be it a deferral or credit voucher. We wish to
                      extend similar flexibility and peace of mind to all our future
                      guests looking to enjoy a well-earned vacation after the dust has
                      settled. We now offer two types of FLEX Options at no extra charge,
                      to choose from when booking:
                    </p>
                  </div>
                </div>
                <div className="row justify-content-md-center py-5">
                  <div className="col-5 m-0 fs-13  text-center">
                    <div>
                      ...
                      <ul>
                        <li>BOOK ANY TOUR OF YOUR CHOICE AND CHANGE THE TRIP DATES</li>
                        <li>AND TOUR DESTINATION 1 TIME FOR FREE*</li>
                        <li>
                          UP TO 60 DAYS BEFORE DEPARTURE. (Not Applicable for Inca Trail)
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <p>
                        ...
                        <br />
                        UP TO 31 DAYS BEFORE DEPARTURE. (Not Applicable for Inca Trail)
                        <br />
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="col-10 listStyle">
                    ...
                    <ul>
                      <li>
                        ...
                        2020. Under High Flex, and under Extreme Flex can be applicable
                        from the time of booking to 2021.
                      </li>
                      <li>
                        ...
                        changed for 2021 the traveler shall be responsible for payment of
                    ...
                    <ul>
                      ...
                      <li>
                        The balance of the tour will be invoiced 60 or 90 days before the
                        new tour start date.
                      </li>
                      <li>
                        If you are still uncertain as to when you will travel, we will
                        issue a credit voucher for the full value of the deposit, with a
                        validity period of 12 months.
                      </li>
                      <li>
                        To re-book a tour using a credit voucher, contact us through our
                        email info@valenciatravelcusco.com or call center.
                      </li>
                      <li>
                        If the tour or departure date to which you are moving is a lower
                        price than the tour you are moving from, we will issue a voucher
                        for the difference in price with 12 month validity.
                      </li>
                      <li>
                    ...
                    <p>
                      ...
                      eligible for EXTREME FLEX terms. Changes permitted:
                    </p>
                    <ul>
                      <li>The date on which you will take the tour</li>
                      <li>The tour program (move between different tours)</li>
                      <li>The country/destination in which you will take the tour</li>
                      <li>
                        You can make departure date changes and can be made up to 31 days
                        prior to the tour departure date. (Doesn’t apply for Inca Trail
                        trek, because of the Ministery of culture.
                      </li>
                      <li>
                        The tour must be taken within 2020 and 2021 months of the original
                        booked tour date.
                      </li>
                      <li>
                        6: If you are uncertain as to when you will be able to travel, we
                        will issue a credit voucher for the full value paid by you, with a
                        validity period of 18 months.
                      </li>
                      <li>
                        To re-book a tour using a voucher, simply contact our
                        info@valenciatravelcusco.com. Where a voucher is issued, we do not
                      ...
                      <li>
                        If the tour or departure date to which you are moving is a higher
                        price than the tour you are moving from, we will require you to
                        make payment of the difference at the time of the change.
                      </li>
                      <li>
                        If the tour or departure date to which you are moving is a lower
                        price than the tour you are moving from, we will issue a voucher
                        for the difference in price with 18 month validity.
                      </li>
                      <li>
                        For private groups, please note that we will require the whole
                        group to make changes as a group. Where the group size reduces due
                        to a change, a re-price of the tour may be required.
                      </li>
                    </ul>
