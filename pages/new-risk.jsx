                ...
                <div className="row justify-content-md-center">
                  <div className="col-10 mb-3">
                    ...
                    <p className="m-0  ">
                      ...
                      world, even the hardy travellers who are participants on Va
                      Expeditions tours, are feeling understandably anxious and seeking
                      assurance. It is clear that for the time being, the complicated web
                      of restrictions and flight cancelations make travel a challenge
                      right now. So we have worked with all our guests on a case-by-case
                      basis to find the best solution for them, be it a deferral or credit
                      voucher. We wish to extend similar flexibility and peace of mind to
                      all our future guests looking to enjoy a well-earned vacation after
                      the dust has settled. We now offer two types of FLEX Options at no
                  ...
                  <div className="col-10 listStyle">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        email info@vaexpedtions.com or use our call centre.
                      </li>
                      <li>
