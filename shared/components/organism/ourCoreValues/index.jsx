    ...
    return (
        <>
          ...
          <div className="col-12 text-center">
              <h2 className="titleUnderline fs-30 text-center">Our Core Values</h2>
          </div>
              ...
              <div className="col-12 mx-auto">
                ...
                <div className="row mb-5">
                  <div className="col-12 col-md-6 mb-5 order-1 align-self-center ">
                    ...
                    of our projects. We value family, tradition and share our passion about what each magical destination has to offer. We 
                ...
                <div className="row mb-5">
                  ...
                  <div className="col-12 col-md-6 mb-5 order-1 order-md-2 align-self-center ">
                    ...
                    circumstances in the face of unexpected events. Through teamwork, we make sure that improvements and renovations are 
                    continually taking place to help us achieve our aims.  
                    </p>
                  </div>
                </div>
                ...
                <div className="row mb-5">
                  <div className="col-12 col-md-6 mb-5 order-1 align-self-center ">
                    ...
                    Through our commitment to social projects, we always welcome the differences which make us human, to generate a deeper connection 
                    with both tourists and local people alike.    
                     </p>
                  </div>
                  <div className="col-12 col-md-6 mb-5 order-2">
                ...
                <div className="row mb-5">
                  ...
                  <div className="col-12 col-md-6 mb-5 order-1 order-md-2 align-self-center ">
                    ...
                    <p className="m-0 fs-17 lh-34">
                    We are a company that is conscious about the environment and we are dedicated to its conservation by using sustainable 
                    and renewable resources where possible to reduce the potential negative impact on the environment.   
                     </p>
                  </div>
                </div>
             </div>
