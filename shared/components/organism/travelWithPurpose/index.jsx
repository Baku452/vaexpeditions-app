                ...
                <div className="row pb-4 itinerary">
                  <div className="col-12 col-md-8 order-2 order-md-1 listStyle">
                    ...
                    <p>
                      ...
                      respect that they deserve. This is reflected in the fair salaries
                      that we share with our great family of local experts. Beyond on
                      that, we have in place a range of incentives and programs to further
                      show our thanks to our great team of local experts, including:
                    </p>
                    <ul>
                ...
                <div className="row pb-4 itinerary">
                  <div className="col-12 col-md-8 order-2 order-md-1">
                    <p>
                      ...
                      actively want to increase the number of employment opportunities for
                      women in the travel industry, and we firmly believe that this will
                    ...
                    <p>
                      With this initiative, we also seek to reduce the gender pay gap, so
                      that we can have more open conversations and set goals to address
                      any issues. Starting in 2020, we began to have equal gender
                      representation among our company spokespersons, to ensure that we
                      better reflect the diversity of our society. We also continuously
                      strive to empower every woman in the communities where we travel
                      with the aim of improving their job opportunities and quality of
                      life. We know it will be constant and hard work, but we are
                      endlessly motivated to walk along this particular path towards a
                      more just society.
                    </p>
                    <p>
                      <b>Our objectives:</b>
                    ...
                    <p>
                      This is what the CIPD has to say: “there is a compelling moral case
                      for diversity and inclusion in the workplace and beyond. Ensuring
                      everyone is treated equally, with dignity and has their fair share
                      of resources (whether that be access to work or equitable pay) is
                      simply the right thing to do. People matter, and we all should have
                      equal opportunity to develop, progress, and be rewarded and
                      recognized at work. Organizations must ensure that their people
                ...
                <div className="row pb-4 itinerary">
                  <div className="col-12 col-md-8 order-2 order-md-1">
                    <p>
                      ...
                      throughout Central and South America, enrich the landscapes that we
                      explore when we set off on one of our adventures. These countries
                      are home to a wonderful array of flora and fauna, which it is why
                      these destinations are some of the most megadiverse places on the
                      planet. From record numbers of marine and continental fish species,
                      butterflies, bird species, amphibians and a number of endemic
                      species of mammals, many of which are endangered and are protected
                      throughout the many national parks.
                    </p>
                    <p>
                      Faced with the threats to wildlife, we have become very much engaged
                      in protecting the flora and fauna of the region. We follow essential
                      fundamentals for animal welfare, and along all of our routes we take
                      great care to respect and preserve the animal world. This includes
                      the welfare of domesticated animals such as llamas, horses, donkeys,
                      alpacas, seals, penguins and sea life species along the coastal
                      regions we visit.
                    </p>
                    <p>
                    ...
                    <p>
                      <ol>
                        <li>
                          Freedom from hunger or thirst by ready access to fresh water and
                      ...
                      <ol>
                        ...
                        <li>
                          <p>
                            ...
                            <ul>
                              <li>
                                Work with our travel partners to reduce printed brochures
                                by 50% and take advantage of electronic brochures.{' '}
                              </li>
                              <li>
                ...
                <div className="row pb-4 itinerary">
                  <div className="col-12 col-md-8 order-2 order-md-1">
                    <p>
                      ...
                      countries that represent an endless number of unique traditions and
                      legacies that are passed from one generation to the next, up to the
                      present day. This includes arts, gastronomy, medicinal remedies,
                      spirituality, personal values, landmarks, monuments and more. We
                      love to connect our travelers with the local heritage and culture,
                      and we consider every trip an educational and enriching experience.
                      This, in turn, helps to preserve the local traditions.{' '}
                    </p>
                    <p>
                      We ensure that every cultural exchange is carried out in an ethical
                      and sustainable way, while not interfering with or altering the
                      local traditions. As a company, we: <br />{' '}
                    </p>
                    <p>
                        ...
                        <p>
                          ...
                          <ul>
                            ...
                            <li>
                              ...
                              seeing the world, through volunteering and coexistence with
                              local communities with their customs, traditions and
                              lifestyle.{' '}
                            </li>
                            <ul>
                              <li>
                ...
                <div className="row pb-4 itinerary">
                  <div className="col-12 col-md-8 order-2 order-md-1">
                    ...
                    <p>
                      ...
                      over quantity, fundamental principles in our new sustainable travel
                      programs.
                    </p>
                    <p>
                      We employ local guides and community leaders so that we can learn
                      about each culture and way of life directly from those who live it.
                      In particular, we can learn from rural indigenous communities about
                      their relationship to the land and how they have practiced
                    ...
                    <p>
                      ...
                      that the profits from our operation go to the local economy. This is
                      incredibly important for conservation as it creates viable local
                      economic alternatives in rural areas, and increases the inherent
                      value of conserving natural landscapes.
                    </p>
                    <p>
                      <b>Our objectives:</b>{' '}
                      <ol>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          least 25% of their menu, either locally (any food obtained
                ...
                <div className="row pb-4 itinerary">
                  <div className="col-12 col-md-8 order-2 order-md-1">
                    <p>
                      ...
                      Cusco. Here are a number of small villages located on the side of a
                      steep mountain. Every year it is a great pleasure for us to bring a
                      little Christmas cheer into the lives of the locals. We dress up in
                      our best Santa Claus costumes and make sure that Christmas in this
                      community is celebrated well.{' '}
                    </p>
                    <p>
                      ...
                      this community faces on a day-to-day basis, but we think it's a good
                      start and a great way to promote more smiles during the holiday
                    ...
                    <ol>
                      <ul>
                        ...
                        <li>
                          ...
                          notebooks, pencils and healthy snacks for children. Each gift is
                          age appropriate.
                        </li>
                      </ul>
                    </ol>
                    <p>
                      ...
                      something small to help these communities, as long as the material
                      does not contaminate or contain plastic.{' '}
                    </p>
                    <p>
                      These treasured items can be as simple as a T-shirt, a pair of
                      socks, a baseball cap, or a pair of shoes. It's okay if these items
                      are second-hand, as long as they're clean and in good condition.
                      Educational materials are also appreciated! Items like notebooks,
                      pens, pencils, rulers, and glue are local favorites. If you really
          ...
          <Accordion.Collapse eventKey={10}>
            <Card.Body className="content-gray">
              <div className="row pb-4 itinerary">
                <div className="col-12 col-md-8 order-2 order-md-1">
                  <p>
                    We want EVERYONE to be able to enjoy Central and South America. That
                    is why we always try to include facilities for those with
                    disabilities, low finance resources or other disadvantaged groups with
                    the aim to integrate people through unique travel experiences.
                  </p>
                  <p>
                    ...
                    reason that we always try to accessibility for people with special
                    needs in our travel itineraries.
                  </p>
                  <p>
                    ...
                    their countries. It is heart breaking to think that people do no have
                    access to their land, history and heritage which is why we try to help
                    local people, wherever possible to have extraordinary experiences that
                    will change their lives for the better. The time is now! for everyone
