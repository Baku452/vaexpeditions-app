...
function Days({ days }) {
  ...
  return (
    <h6 className="fs-13 m-0">
      <span className="me-2 font-weight-bold">Duration:</span> {getNameDays(days)}
    </h6>
  );
}
            ...
            <div className="row align-items-start justify-content-start">
              <div className="col-12">
                ...
                <div className="d-flex fs-13 mb-2">
                  <h6 className="fs-13 font-weight-bold me-2">Trip Type: </h6>
                  <>
                ...
                <div className="d-flex fs-13 mb-3 align-items-center">
                  <h6 className="fs-13 font-weight-bold me-2 mb-0">Activity level: </h6>
                  <span>{activity}</span>
                </div>
                {destination ? (
                  <div className="d-flex fs-13 mb-3 align-items-center">
                    <h6 className="fs-13 font-weight-bold me-2 mb-0">Destination: </h6>
